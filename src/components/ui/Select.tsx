      ...
      <div className={cn("w-full", className)}>
        ...
        <div className="relative w-full">
          <select
            ref={ref}
            className={cn(
              "h-10 px-3 pr-8 border border-[#E0E0E0] rounded-md text-sm bg-white focus:border-[#8B5A2B] focus:ring-1 focus:ring-[#8B5A2B] outline-none transition-all duration-150 w-full text-[#8B5A2B] appearance-none",
