        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${
              method === tab.key
                ? "border-[#1A8FD1] text-[#1A8FD1]"
                : "border-transparent text-[#6B6B6B] hover:text-[#1A8FD1]"
            }`}
          >
            <tab.icon size={14} />
            {tab.label}
        ...
        <div className="space-y-4">
          ...
          {(mpesaStatus === "processing" || mpesaStatus === "polling") && (
            <div className="text-center py-6 space-y-3">
              ...
              <p className="text-sm font-medium text-[#1A8FD1]">Waiting for M-Pesa confirmation...</p>
          ...
          {mpesaStatus === "success" && (
            <div className="space-y-4">
              <div className="text-center py-4 space-y-2">
                ...
                <p className="text-sm font-medium text-[#1A8FD1]">M-Pesa payment confirmed!</p>
          ...
          {mpesaStatus === "failed" && (
            <div className="space-y-4">
              <div className="text-center py-4 space-y-2">
                ...
                <p className="text-sm font-medium text-[#1A8FD1]">Payment failed</p>
