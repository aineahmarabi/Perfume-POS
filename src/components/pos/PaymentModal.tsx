        ...
        <div className="space-y-4">
          ...
          {(mpesaStatus === "processing" || mpesaStatus === "polling") && (
            <div className="text-center py-6 space-y-3">
              ...
              <p className="text-sm font-medium text-[#1E1B3A]">Waiting for M-Pesa confirmation...</p>
          ...
          {mpesaStatus === "success" && (
            <div className="space-y-4">
              <div className="text-center py-4 space-y-2">
                ...
                <p className="text-sm font-medium text-[#1E1B3A]">M-Pesa payment confirmed!</p>
          ...
          {mpesaStatus === "failed" && (
            <div className="space-y-4">
              <div className="text-center py-4 space-y-2">
                ...
                <p className="text-sm font-medium text-[#1E1B3A]">Payment failed</p>
