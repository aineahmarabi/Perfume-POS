                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="text-[#9B9B9B] hover:text-[#1A8FD1] transition-colors"
                          >
                            {expandedProduct === product._id ? <ChevronDown size={14} /> : <ChevronRight size={14} />}
                          </button>
                          <span className="font-medium text-[#1A8FD1]">{product.name}</span>
                        </div>
                      </TableCell>
              ...
              <div key={product._id} className="bg-white border border-[#E0E0E0] rounded-md p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-sm text-[#1A8FD1] truncate">{product.name}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <div className="flex items-center gap-1 mb-1">
                <label className="text-sm font-medium text-[#1A8FD1]">Brand *</label>
                {!showAddBrand && (
                  <button
                    type="button"
                    onClick={() => { setShowAddBrand(true); setNewBrandName(""); }}
                    className="ml-auto flex items-center gap-1 text-sm text-[#1A8FD1] hover:text-[#1570A8] font-medium"
                    title="Add new brand"
                  >
                    <Plus size={13} /> New
                  </button>
            ...
            <div>
              <div className="flex items-center gap-1 mb-1">
                <label className="text-sm font-medium text-[#1A8FD1]">Category *</label>
                {!showAddCategory && (
                  <button
                    type="button"
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-sm text-[#1A8FD1] hover:underline font-medium"
            >
