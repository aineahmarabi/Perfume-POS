...
export function POSPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white overflow-hidden pb-0 md:pb-0">
      {/* POS Header */}
      <header className="h-14 bg-[#8B5A2B] text-white flex items-center px-4 gap-3 flex-shrink-0">
        {/* Brand */}
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {mobileTab === "products" && (
          <button
            ...
            className="md:hidden fixed bottom-20 right-4 z-30 flex items-center gap-2 bg-[#8B5A2B] text-white pl-4 pr-5 py-3 rounded-full shadow-lg text-sm font-semibold"
          >
