    ...
    <div className="min-h-screen bg-[#F7F7F7] flex items-center justify-center p-4">
      <div className="bg-white border border-[#E0E0E0] rounded-md p-8 w-full max-w-sm shadow-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-[#8B5A2B] tracking-tight">{shopName}</h1>
          ...
          {digits.map((d, i) => {
            ...
            return (
              <button
                ...
                className="h-14 rounded-md text-xl font-medium text-[#8B5A2B] hover:bg-[#F7F7F7] active:bg-[#F0F0F0] border border-[#E0E0E0] transition-colors duration-100 disabled:opacity-30"
              >
                {d}
              </button>
            );
